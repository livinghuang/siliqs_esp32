...
lorawan_params_settings params = {
    ...
    .LORAWAN_1_1 = true,                                                                                          // LORAWAN 1.1 or 1.0
    .JOINEUI = 0x0000000000000000,                                                                                // Join EUI
    .DEVEUI = 0x110aa88888888888,                                                                                 // DEVEUI, if OTAA, DEVEUI will used. if ABP, DEVEUI will be ignored
    ...
    .NWKxKEY = {0xaa, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55},  // if OTAA, NWKxKEY = NULL use lorawan v1.0.x, if ABP, APPxKEY = NWKSKEY
...
void setup()
{
  ...
  lorawan.begin(); // false: not use auto generate keys
}
