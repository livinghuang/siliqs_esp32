...
#define RADIOLIB_LORAWAN_CHANNEL_NONE {.enabled = false, .idx = RADIOLIB_LORAWAN_CHANNEL_INDEX_NONE, .freq = 0, .drMin = 0, .drMax = 0, .dr = RADIOLIB_LORAWAN_DATA_RATE_UNUSED, .available = false}
...
struct LoRaWANBand_t
{
  ...
  LoRaWANChannel_t txFreqs[8]; // Living: 20241213 ,change it from 3 to 8 for 8 channels support
...
extern const LoRaWANBand_t AS923_1; // Living: 20241213 added AS923_1 for 8 channels support
...
enum LoRaWANBandNum_t
{
  ...
  BandCN500,
  BandAS923,
  BandAS923_1, // Living: 20241213 added AS923_1 for 8 channels support
  BandAS923_2,
  BandAS923_3,
  BandAS923_4,
  BandKR920,
