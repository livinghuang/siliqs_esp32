...
public:
  ...
  */
  int16_t begin(float freq = 923.2, float bw = 125.0, uint8_t sf = 9, uint8_t cr = 7, uint8_t syncWord = RADIOLIB_SX126X_SYNC_WORD_PRIVATE, int8_t power = 10, uint16_t preambleLength = 8, float tcxoVoltage = 1.6, bool useRegulatorLDO = false);
  ...
  /*!
    ...
    \returns \ref status_codes
  */
  int16_t beginFSK(float freq = 923.2, float br = 4.8, float freqDev = 5.0, float rxBw = 156.2, int8_t power = 20, uint16_t preambleLength = 16, float tcxoVoltage = 0, bool useRegulatorLDO = false);
