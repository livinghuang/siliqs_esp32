...
public:
  ...
  */
  ...
  /*!
    ...
    \param freq Carrier frequency in MHz. Defaults to 923.0 MHz.
  ...
  */
  int16_t begin(float freq = 923.0, float bw = 125.0, uint8_t sf = 9, uint8_t cr = 7, uint8_t syncWord = RADIOLIB_SX126X_SYNC_WORD_PRIVATE, int8_t power = 10, uint16_t preambleLength = 8, float tcxoVoltage = 1.6, bool useRegulatorLDO = false);
  ...
  /*!
    ...
    \returns \ref status_codes
  */
  int16_t beginFSK(float freq = 923.0, float br = 4.8, float freqDev = 5.0, float rxBw = 156.2, int8_t power = 10, uint16_t preambleLength = 16, float tcxoVoltage = 1.6, bool useRegulatorLDO = false);
  ...
  /*!
    ...
    \returns \ref status_codes
  */
  int16_t beginLRFHSS(float freq = 923.0, uint8_t bw = RADIOLIB_SX126X_LR_FHSS_BW_722_66, uint8_t cr = RADIOLIB_SX126X_LR_FHSS_CR_2_3, bool narrowGrid = true, int8_t power = 10, float tcxoVoltage = 1.6, bool useRegulatorLDO = false);
