...
#if RADIOLIB_VERBOSE_ASSERT || RADIOLIB_DEBUG_BASIC || RADIOLIB_DEBUG_PROTOCOL || RADIOLIB_DEBUG_SPI
...
#define RADIOLIB_ASSERT(STATEVAR)                                 \
  {                                                               \
    ...
    {                                                             \
      Serial.printf("%d at %s:%d", STATEVAR, __FILE__, __LINE__); \
      return (STATEVAR);                                          \
    }                                                             \
  }
#define RADIOLIB_ASSERT_PTR(PTR)                          \
  {                                                       \
    if ((PTR) == NULL)                                    \
    {                                                     \
      Serial.printf("NULL at %s:%d", __FILE__, __LINE__); \
