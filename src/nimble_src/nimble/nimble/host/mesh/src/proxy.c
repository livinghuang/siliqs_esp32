...
#include "nimble_src/nimble/nimble/host/include/host/ble_att.h"
#include "nimble_src/nimble/nimble/host/services/gatt/include/services/gatt/ble_svc_gatt.h"
#include "nimble_src/nimble/nimble/host/src/ble_hs_priv.h"
...
int bt_mesh_proxy_prov_disable(bool disconnect)
{
	...
	for (i = 0; i < ARRAY_SIZE(clients); i++)
	{
		...
		if ((client->conn_handle == BLE_HS_CONN_HANDLE_NONE) || (client->filter_type != PROV))
		{
			continue;
		}
