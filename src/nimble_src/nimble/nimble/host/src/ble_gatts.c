...
#include "nimble_src/nimble/nimble/host/include/host/ble_store.h"
#include "ble_hs_priv.h"

#ifdef ESP_PLATFORM
#include "nimble_src/nimble/esp_port/port/include/esp_nimble_mem.h"
#endif
...
STATS_SECT_DECL(ble_gatts_stats)
ble_gatts_stats;
...
int ble_gatts_init(void)
{
    ...
    rc = stats_init_and_reg(
        STATS_HDR(ble_gatts_stats), STATS_SIZE_INIT_PARMS(ble_gatts_stats, STATS_SIZE_32), STATS_NAME_INIT_PARMS(ble_gatts_stats), "ble_gatts");
    if (rc != 0)
    {
        return BLE_HS_EOS;
    }
