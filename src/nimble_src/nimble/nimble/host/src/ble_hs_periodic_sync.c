...
#include "nimble_src/nimble/nimble/host/include/host/ble_hs_id.h"
...
static os_membuf_t ble_hs_psync_elem_mem[OS_MEMPOOL_SIZE(MYNEWT_VAL(BLE_MAX_PERIODIC_SYNCS),
