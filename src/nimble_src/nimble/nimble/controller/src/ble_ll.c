...
#include <assert.h>
#include <string.h>
#include "nimble_src/nimble/porting/nimble/include/sysinit/sysinit.h"
...
#include "nimble_src/nimble/porting/nimble/include/stats/stats.h"
...
#else
    usecs = (((payload_len) + BLE_LL_PDU_HDR_LEN + BLE_LL_ACC_ADDR_LEN + BLE_LL_PREAMBLE_LEN + BLE_LL_CRC_LEN) << 3);
#endif
